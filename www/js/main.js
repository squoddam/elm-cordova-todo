...
Elm.OneTask = Elm.OneTask || {};
Elm.OneTask.make = function (_elm) {
   "use strict";
   _elm.OneTask = _elm.OneTask || {};
   if (_elm.OneTask.values) return _elm.OneTask.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Array = Elm.Array.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   ...
   $String = Elm.String.make(_elm);
   var _op = {};
   var createHeightsList = function (sbts) {
      return A2($List.map,
      function (_p0) {
         var _p1 = _p0;
         return _p1._1;
      ...
      F2(function (i,_p4) {
         var _p5 = _p4;
         return {ctor: "_Tuple2",_0: _p5._0,_1: i * 15};
      }),
      sbts)));
   };
   var divideBy = F3(function (fn,thing,lst) {
      return fn(thing) ? A2($Basics._op["++"],
      lst,
      _U.list([thing])) : A2($List._op["::"],thing,lst);
   });
   var createIndexPairs = function (sbts) {
      return A2($List.indexedMap,
      F2(function (i,sbt) {
         return {ctor: "_Tuple2",_0: i,_1: sbt};
      }),
      sbts);
   };
   var update = F2(function (action,model) {
      var _p6 = action;
      switch (_p6.ctor)
      {case "ToggleFolding": return _U.update(model,
           {showSubTasks: $Basics.not(model.showSubTasks)});
         case "SubTaskInputChange": return _U.update(model,
           {currentSubTaskInput: _p6._0});
         case "AddSubTask":
         return _U.cmp($String.length(model.currentSubTaskInput),
           0) > 0 ? _U.update(model,
           {subTasks: A2($Basics._op["++"],
           model.subTasks,
           _U.list([{id: model.lastSTID
                    ,text: model.currentSubTaskInput
                    ,checked: false}]))
           ,currentSubTaskInput: ""
           ,lastSTID: model.lastSTID + 1}) : model;
         case "ToggleSubTask": var toggleChecking = function (subT) {
              return _U.eq(subT.id,_p6._0) ? _U.update(subT,
              {checked: $Basics.not(subT.checked)}) : subT;
           };
           var newSubTasks = A2($List.map,toggleChecking,model.subTasks);
           return _U.update(model,{subTasks: newSubTasks});
         case "DeleteTask": return _U.update(model,{text: ""});
         default: return model;}
   });
   var NoOp = {ctor: "NoOp"};
   var DeleteTask = {ctor: "DeleteTask"};
   var deleteButton = F2(function (address,model) {
      return A2($Html.div,
      _U.list([$Html$Attributes.$class("dlt-btn")
              ,A2($Html$Events.onClick,address,DeleteTask)]),
      _U.list([$Html.text("Delete")]));
   });
   var ToggleSubTask = function (a) {
      return {ctor: "ToggleSubTask",_0: a};
   };
   var AddSubTask = {ctor: "AddSubTask"};
   var SubTaskInputChange = function (a) {
      return {ctor: "SubTaskInputChange",_0: a};
   };
   var ToggleFolding = {ctor: "ToggleFolding"};
   var view = F2(function (address,model) {
      var subHeightsArray = $Array.fromList(createHeightsList(A3($List.foldr,
      divideBy(function (_p7) {
         var _p8 = _p7;
         return _p8._1.checked;
      }),
      _U.list([]),
      createIndexPairs(model.subTasks))));
      var subTaskLine = F2(function (i,subT) {
         var getIntToString = function (m) {
            var _p9 = m;
            if (_p9.ctor === "Just") {
                  return $Basics.toString(_p9._0);
               } else {
                  return "0";
               }
         };
         var subTaskClass = subT.checked ? "line subtask subtask__checked" : "line subtask";
         return A2($Html.div,
         _U.list([$Html$Attributes.$class(subTaskClass)
                 ,$Html$Attributes.style(_U.list([{ctor: "_Tuple2"
                                                  ,_0: "top"
                                                  ,_1: A2($Basics._op["++"],
                                                  getIntToString(A2($Array.get,i,subHeightsArray)),
                                                  "vw")}]))
                 ,A2($Html$Events.onClick,address,ToggleSubTask(subT.id))]),
         _U.list([$Html.text(subT.text)]));
      });
      var subTasksInputWButton = A2($Html.div,
      _U.list([$Html$Attributes.$class("line subTask__inWBtn")]),
      _U.list([A2($Html.input,
              _U.list([A3($Html$Events.on,
                      "change",
                      $Html$Events.targetValue,
                      function (input) {
                         return A2($Signal.message,address,SubTaskInputChange(input));
                      })
                      ,$Html$Attributes.value(model.currentSubTaskInput)
                      ,$Html$Attributes.$class("subtask__input")]),
              _U.list([]))
              ,A2($Html.button,
              _U.list([A2($Html$Events.onClick,address,AddSubTask)
                      ,$Html$Attributes.$class("subtask__button")]),
              _U.list([$Html.text("add subtask")]))]));
      var subTasks = A2($Html.div,
      _U.list([$Html$Attributes.$class("subtask__list")
              ,$Html$Attributes.style(_U.list([{ctor: "_Tuple2"
                                               ,_0: "height"
                                               ,_1: model.showSubTasks ? A2($Basics._op["++"],
                                               $Basics.toString(($List.length(model.subTasks) + 1) * 15),
                                               "vw") : "0vw"}]))]),
      $List.concat(_U.list([A2($List.indexedMap,
                           subTaskLine,
                           model.subTasks)
                           ,_U.list([subTasksInputWButton])])));
      var loaderHeight = $Basics.toString(A2(F2(function (x,y) {
         return x * y;
      }),
      100,
      function (allChecked) {
         return allChecked / $Basics.toFloat($List.length(model.subTasks));
      }($Basics.toFloat($List.length(A2($List.filter,
      function (_) {
         return _.checked;
      },
      model.subTasks))))));
      var taskClass = model.showSubTasks ? "line task__line task__line_open" : "line task__line";
      var taskText = A2($Html.div,
      _U.list([A2($Html$Events.onClick,address,ToggleFolding)
              ,$Html$Attributes.$class(taskClass)]),
      _U.list([$Html.text(model.text)
              ,A2($Html.div,
              _U.list([$Html$Attributes.$class("task__loader")
                      ,$Html$Attributes.style(_U.list([{ctor: "_Tuple2"
                                                       ,_0: "height"
                                                       ,_1: A2($Basics._op["++"],loaderHeight,"%")}]))
                      ,A2($Html$Attributes.attribute,"data-h",loaderHeight)]),
              _U.list([]))
              ,A2(deleteButton,address,model)]));
      return A2($Html.div,_U.list([]),_U.list([taskText,subTasks]));
   });
   var initialModel = {text: ""
                      ...
                      ,currentSubTaskInput: ""
                      ,lastSTID: 0};
   var initialSubTasks = _U.list([{id: 0
                                  ,text: "Subtask num. 1"
                                  ,checked: false}
                                 ,{id: 1,text: "Subtask num. 2",checked: true}]);
   var Model = F5(function (a,b,c,d,e) {
      return {text: a
             ,subTasks: b
             ,showSubTasks: c
             ,currentSubTaskInput: d
             ,lastSTID: e};
   });
   var SubTask = F3(function (a,b,c) {
      return {id: a,text: b,checked: c};
   });
   return _elm.OneTask.values = {_op: _op
                                ,SubTask: SubTask
                                ,Model: Model
                                ,initialSubTasks: initialSubTasks
                                ,initialModel: initialModel
                                ,ToggleFolding: ToggleFolding
                                ,SubTaskInputChange: SubTaskInputChange
                                ...
                                ,view: view
                                ,createIndexPairs: createIndexPairs
                                ,divideBy: divideBy
                                ,createHeightsList: createHeightsList};
};
Elm.Main = Elm.Main || {};
Elm.Main.make = function (_elm) {
   ...
   $List = Elm.List.make(_elm),
   $Maybe = Elm.Maybe.make(_elm),
   $OneTask = Elm.OneTask.make(_elm),
   $Result = Elm.Result.make(_elm),
   $Signal = Elm.Signal.make(_elm),
   $String = Elm.String.make(_elm);
   var _op = {};
   var fromJS = Elm.Native.Port.make(_elm).inboundSignal("fromJS",
   "Main.Model",
   function (v) {
      return typeof v === "object" && "currentInput" in v && "tasks" in v && "nextId" in v ? {_: {}
                                                                                             ,currentInput: typeof v.currentInput === "string" || typeof v.currentInput === "object" && v.currentInput instanceof String ? v.currentInput : _U.badPort("a string",
                                                                                             v.currentInput)
                                                                                             ,tasks: typeof v.tasks === "object" && v.tasks instanceof Array ? Elm.Native.List.make(_elm).fromArray(v.tasks.map(function (v) {
                                                                                                return typeof v === "object" && v instanceof Array ? {ctor: "_Tuple2"
                                                                                                                                                     ...
                                                                                                                                                     v[0])
                                                                                                                                                     ,_1: typeof v[1] === "object" && "text" in v[1] && "subTasks" in v[1] && "showSubTasks" in v[1] && "currentSubTaskInput" in v[1] && "lastSTID" in v[1] ? {_: {}
                                                                                                                                                                                                                                                                                                              ,text: typeof v[1].text === "string" || typeof v[1].text === "object" && v[1].text instanceof String ? v[1].text : _U.badPort("a string",
                                                                                                                                                                                                                                                                                                              v[1].text)
                                                                                                                                                                                                                                                                                                              ,subTasks: typeof v[1].subTasks === "object" && v[1].subTasks instanceof Array ? Elm.Native.List.make(_elm).fromArray(v[1].subTasks.map(function (v) {
                                                                                                                                                                                                                                                                                                                 return typeof v === "object" && "id" in v && "text" in v && "checked" in v ? {_: {}
                                                                                                                                                                                                                                                                                                                                                                                              ...
                                                                                                                                                                                                                                                                                                                                                                                              v.text)
                                                                                                                                                                                                                                                                                                                                                                                              ,checked: typeof v.checked === "boolean" ? v.checked : _U.badPort("a boolean (true or false)",
                                                                                                                                                                                                                                                                                                                                                                                              v.checked)} : _U.badPort("an object with fields `id`, `text`, `checked`",
                                                                                                                                                                                                                                                                                                                 v);
                                                                                                                                                                                                                                                                                                              })) : _U.badPort("an array",
                                                                                                                                                                                                                                                                                                              v[1].subTasks)
                                                                                                                                                                                                                                                                                                              ,showSubTasks: typeof v[1].showSubTasks === "boolean" ? v[1].showSubTasks : _U.badPort("a boolean (true or false)",
                                                                                                                                                                                                                                                                                                              v[1].showSubTasks)
                                                                                                                                                                                                                                                                                                              ,currentSubTaskInput: typeof v[1].currentSubTaskInput === "string" || typeof v[1].currentSubTaskInput === "object" && v[1].currentSubTaskInput instanceof String ? v[1].currentSubTaskInput : _U.badPort("a string",
                                                                                                                                                                                                                                                                                                              v[1].currentSubTaskInput)
                                                                                                                                                                                                                                                                                                              ,lastSTID: typeof v[1].lastSTID === "number" && isFinite(v[1].lastSTID) && Math.floor(v[1].lastSTID) === v[1].lastSTID ? v[1].lastSTID : _U.badPort("an integer",
                                                                                                                                                                                                                                                                                                              v[1].lastSTID)} : _U.badPort("an object with fields `text`, `subTasks`, `showSubTasks`, `currentSubTaskInput`, `lastSTID`",
                                                                                                                                                     v[1])} : _U.badPort("an array",
                                                                                                v);
                                                                                             })) : _U.badPort("an array",v.tasks)
                                                                                             ,nextId: typeof v.nextId === "number" && isFinite(v.nextId) && Math.floor(v.nextId) === v.nextId ? v.nextId : _U.badPort("an integer",
                                                                                             v.nextId)} : _U.badPort("an object with fields `currentInput`, `tasks`, `nextId`",
      v);
   });
   var NoOp = {ctor: "NoOp"};
   var tasksMail = $Signal.mailbox(NoOp);
   var ModifyTask = F2(function (a,b) {
      return {ctor: "ModifyTask",_0: a,_1: b};
   });
   var taskView = F2(function (address,_p0) {
      var _p1 = _p0;
      return A2($OneTask.view,
      A2($Signal.forwardTo,address,ModifyTask(_p1._0)),
      _p1._1);
   });
   var NewTask = {ctor: "NewTask"};
   var GetTasks = function (a) {
      return {ctor: "GetTasks",_0: a};
   };
   var getTasks = A2($Signal.map,
   function (model) {
      return GetTasks(model);
   },
   fromJS);
   var InputChange = function (a) {
      return {ctor: "InputChange",_0: a};
   };
   var view = F2(function (address,model) {
      var newTaskButton = A2($Html.button,
      _U.list([A2($Html$Events.onClick,address,NewTask)
              ,$Html$Attributes.$class("new-task__button")]),
      _U.list([$Html.text("add task")]));
      var newTaskInput = A2($Html.input,
      _U.list([A3($Html$Events.on,
              "change",
              $Html$Events.targetValue,
              function (input) {
                 return A2($Signal.message,address,InputChange(input));
              })
              ,$Html$Attributes.$class("new-task__input")
              ,$Html$Attributes.value(model.currentInput)]),
      _U.list([]));
      var newTaskControl = A2($Html.div,
      _U.list([$Html$Attributes.$class("new-task")]),
      _U.list([newTaskInput,newTaskButton]));
      var tasks = A2($List.map,taskView(address),model.tasks);
      return A2($Html.div,
      _U.list([]),
      _U.list([A2($Html.div,
              _U.list([$Html$Attributes.$class("task__list")]),
              tasks)
              ,newTaskControl]));
   });
   var oneTaskInitialModel = $OneTask.initialModel;
   var update = F2(function (action,model) {
      var _p2 = action;
      switch (_p2.ctor)
      {case "InputChange": return _U.update(model,
           {currentInput: _p2._0});
         case "NewTask":
         return _U.cmp($String.length(model.currentInput),
           0) > 0 ? _U.update(model,
           {tasks: A2($Basics._op["++"],
           model.tasks,
           _U.list([{ctor: "_Tuple2"
                    ,_0: model.nextId
                    ,_1: _U.update(oneTaskInitialModel,
                    {text: model.currentInput})}]))
           ,currentInput: ""
           ,nextId: model.nextId + 1}) : model;
         case "ModifyTask": var updateTask = function (_p3) {
              var _p4 = _p3;
              var _p6 = _p4._1;
              var _p5 = _p4._0;
              return _U.eq(_p5,_p2._0) ? {ctor: "_Tuple2"
                                         ,_0: _p5
                                         ,_1: A2($OneTask.update,_p2._1,_p6)} : {ctor: "_Tuple2"
                                                                                ,_0: _p5
                                                                                ,_1: _p6};
           };
           var newTasks = A2($List.map,updateTask,model.tasks);
           return _U.update(model,
           {tasks: A2($List.filter,
           function (_p7) {
              var _p8 = _p7;
              return _U.cmp($String.length(_p8._1.text),0) > 0;
           },
           newTasks)});
         case "GetTasks": return _p2._0;
         default: return model;}
   });
   var initialModel = {currentInput: ""
                      ,tasks: _U.list([])
                      ,nextId: 0};
   var modelSignal = A3($Signal.foldp,
   update,
   initialModel,
   A2($Signal.merge,tasksMail.signal,getTasks));
   var main = A2($Signal.map,view(tasksMail.address),modelSignal);
   var toJS = Elm.Native.Port.make(_elm).outboundSignal("toJS",
   function (v) {
      return {currentInput: v.currentInput
             ,tasks: Elm.Native.List.make(_elm).toArray(v.tasks).map(function (v) {
                return [v._0
                       ,{text: v._1.text
                        ,subTasks: Elm.Native.List.make(_elm).toArray(v._1.subTasks).map(function (v) {
                           return {id: v.id,text: v.text,checked: v.checked};
                        })
                        ,showSubTasks: v._1.showSubTasks
                        ,currentSubTaskInput: v._1.currentSubTaskInput
   ...
   var Model = F3(function (a,b,c) {
      return {currentInput: a,tasks: b,nextId: c};
   });
   return _elm.Main.values = {_op: _op
                             ,Model: Model
                             ,initialModel: initialModel
                             ,oneTaskInitialModel: oneTaskInitialModel
